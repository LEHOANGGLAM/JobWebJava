...
<div class="job-listing-area pt-120 pb-120">
    <div class="container">
        <div class="row">
            ...
            <%@include file="_filterCompany.jsp"%>
            <!-- Right content -->
                            ...
                            <div class="col-lg-12">
                                <div class="count-job mb-35">    
                                    ...
                                    <span> <fmt:formatNumber type = "number" 
                                                      maxIntegerDigits = "6" value = "${comCounter}" /> Companies found</span>
                ...
                <div class="single-wrap d-flex justify-content-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-start">
                            <c:forEach begin="1" end="${Math.ceil(comCounter/pageSize)}" var="i">
                                <c:url value="/companyList" var="u">
