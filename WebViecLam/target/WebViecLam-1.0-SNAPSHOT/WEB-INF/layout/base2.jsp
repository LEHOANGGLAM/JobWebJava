...
<html lang="vi">
    ...
    <head>    
        ...
        <link href="<c:url value="/css2/woocommerce.min.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/responsive.min.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/style.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/packages.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/mas-wp-job-manager-company-reviews.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/line-awesome.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/frontend.css"/>" rel="stylesheet" type="text/css"> 
        <link href="<c:url value="/css2/font-awesome.min.css"/>" rel="stylesheet" type="text/css">
        <link href="<c:url value="/css2/base.min.css"/>" rel="stylesheet" type="text/css">
